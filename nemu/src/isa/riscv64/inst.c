...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 110 ????? 00000 11", lwu, I, uint32_t t = Mr(src1 + src2, 4);R(dest) = SEXT(U32(t), 33));
  ...
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu, I, uint8_t t = Mr(src1 + src2, 1); R(dest) = SEXT((uint8_t)(t), 9));  //
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 01110 11", subw, R, R(dest) = (int32_t)SEXT(src1 - src2, 32)); //
  /*add by leesum*/
